  ...
  removedMasterWorker =
    map
      (
        ...
        mkRemovedOptionModule [ "services" "buildbot-nix" "worker" name ] ''
          nixbot no longer uses buildbot workers; builds run inside the
    ...
    ++ [
      (mkRemovedOptionModule [ "services" "buildbot-nix" "master" "dbUrl" ] ''
        ...
        For a remote database set services.nixbot.database.url or
      ...
      (mkRemovedOptionModule [ "services" "buildbot-nix" "master" "github" "tokenFile" ] ''
        ...
        services.nixbot.github.appId / appSecretKeyFile.
      '')
